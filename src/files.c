...
void InitGameDirectories(char *argv0)
{
	...
	*/
	...
	} else if (check_game_directory("sdmc:/switch/avp_gold")) {
		gamedir = "sdmc:/switch/avp_gold";
	}
#endif
	...
	} else if (stat("sdmc:/switch/avp_gold", &st) == 0) {
		localdir = strdup("sdmc:/switch/avp_gold");
